...
const objectOfIndexes ={triangleOne: [0,1,2,4], 
                        triangleTwo: [2,5,8,4], 
...
var gameBoard, chualalaPlaying, onlyPlayerOnePlaying = true, onlyPlayerTwoPlaying = true;
...
switch(true){
  case sitPodClass === 'top-left': squareOrTriangle = 'squareArrayOne';
  break;
  case sitPodClass === 'top-centre': squareOrTriangle = 'triangleOne';
  break;
  case sitPodClass === 'top-right': squareOrTriangle = 'squareArrayTwo';
  break;
  case sitPodClass === 'left-centre': squareOrTriangle = 'triangleFour';
  break;
  case sitPodClass === 'right-centre':squareOrTriangle =  'triangleTwo';
  break;
  case sitPodClass === 'bottom-left': squareOrTriangle = 'squareArrayFour';
  break;
  case sitPodClass === 'bottom-centre': squareOrTriangle = 'triangleThree';
  break;
  case sitPodClass === 'bottom-right': squareOrTriangle = 'squareArrayThree';
  break;
  case sitPodClass === 'centre': squareOrTriangle = 'centerPiece';
  break;
}
...
function resetGame(){
  ...
  function restorePlayPodHomeClasses(){
    ...
    cList = item.classList.item(1);
      ...
      if(id === 'player1-playpod-1'){item.classList.replace(cList, 'bottom-left');}
      if(id === 'player1-playpod-2'){item.classList.replace(cList, 'bottom-centre');}
      if(id === 'player1-playpod-3'){item.classList.replace(cList, 'bottom-right');}
    ...
    cList = item.classList.item(1);
      ...
      if(id === 'player2-playpod-1'){item.classList.replace(cList, 'top-left');}
      if(id === 'player2-playpod-2'){item.classList.replace(cList, 'top-centre');}
      if(id === 'player2-playpod-3'){item.classList.replace(cList, 'top-right');}
